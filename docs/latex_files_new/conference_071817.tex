...
\section{Evaluation}
	...
	\indent In following subsection we present results of our test with brief sumarization.
		...
		\begin{figure}[!h]
		\centering
		\subfloat[]{\includegraphics[width=8cm]{graph12}} \hfill
	...
	%\subsubsection{Average throughput - 4 concurrent connections}
		\begin{figure}[!h]
		\centering
		\subfloat[]{\includegraphics[width=8cm]{graph3}} \hfill
		...
		\begin{figure}[!h]
		\centering
		\subfloat[]{\includegraphics[width=8cm]{graph5}} \hfill
