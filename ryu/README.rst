...
Scripts used in our implementation: ryu/app/aks3.py
In /ryu/app you can find multiple scripts used throughout the semester like simple_switch, shortest path forwarding switch, etc.
